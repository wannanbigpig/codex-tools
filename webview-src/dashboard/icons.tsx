...
export function renderDetailsIcon() {
  return (
    <svg viewBox="0 0 1024 1024" aria-hidden="true">
      <path
...
export function renderRemoveIcon() {
  return (
    <svg viewBox="0 0 1024 1024" aria-hidden="true">
      <path
...
export function GlobeIcon() {
  return (
    <svg class="button-icon" viewBox="0 0 24 24" aria-hidden="true">
      <circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" stroke-width="1.8" />
      <path d="M3.5 12h17" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" />
      <path
...
export function CopyIcon() {
  return (
    <svg class="button-icon" viewBox="0 0 24 24" aria-hidden="true">
      <rect x="9" y="9" width="10" height="10" rx="2.2" fill="none" stroke="currentColor" stroke-width="1.8" />
      <path
  ...
  return (
    <svg class="button-icon" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M9 13.5h7" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" />
    </svg>
  );
}
